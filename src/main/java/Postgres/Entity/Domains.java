...
public class Domains {
    ...
    public String toString() {
        return "{\"Domains\":{"
                ...
                + ", \"getFieldSlug\":\"" + getFieldSlug + "\""
                + ", \"getFieldOwner\":\"" + getFieldOwner + "\""
                + ", \"getFieldIpv6\":\"" + getFieldIpv6 + "\""
                + ", \"getFieldIp\":\"" + getFieldIp + "\""
                + ", \"getFieldSuspendtime\":\"" + getFieldSuspendtime + "\""
                + ", \"getFieldIsLocked\":\"" + getFieldIsLocked + "\""
                + ", \"getFieldSuspendreason\":\"" + getFieldSuspendreason + "\""
                + ", \"getFieldEmail\":\"" + getFieldEmail + "\""
                + ", \"getFieldDomain\":\"" + getFieldDomain + "\""
                + ", \"getFieldSuspended\":\"" + getFieldSuspended + "\""
                + ", \"getFieldUnixStardate\":\"" + getFieldUnixStardate + "\""
                + ", \"getFieldUser\":\"" + getFieldUser + "\""
                + ", \"getFieldPlan\":\"" + getFieldPlan + "\""
                + ", \"getFieldShell\":\"" + getFieldShell + "\""
                + ", \"getFieldPartition\":\"" + getFieldPartition + "\""
                + ", \"getFieldTheme\":\"" + getFieldTheme + "\""
                + ", \"getFieldHostId\":\"" + getFieldHostId + "\""
                + ", \"getFieldSiteOwnerId\":\"" + getFieldSiteOwnerId + "\""
                + ", \"getFieldCreatedAt\":\"" + getFieldCreatedAt + "\""
                + ", \"getFieldUpdatedAt\":\"" + getFieldUpdatedAt + "\""
                + ", \"getGetFieldStatusId\":\"" + getGetFieldStatusId + "\""
                + ", \"getFieldDir\":\"" + getFieldDir + "\""
                + ", \"getFieldIsParent\":\"" + getFieldIsParent + "\""
                + ", \"getFieldRootdomain\":\"" + getFieldRootdomain + "\""
                + ", \"getFieldIsSubdomain\":\"" + getFieldIsSubdomain + "\""
                + ", \"getFieldIsAddondomain\":\"" + getFieldIsAddondomain + "\""
                + "}}";
    }
}
